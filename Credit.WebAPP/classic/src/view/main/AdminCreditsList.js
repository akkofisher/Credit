Ext.define('CreditAPP.view.main.AdminCreditsListGrid', {
            ...
            items: [
                {
                    ...
                    handler: function (grid, rowIndex) {
                        ...
                        showStatusChangeWindow(record, grid);
                    }
                }
            ]
        },
...
function showStatusChangeWindow(record, grid) {
        ...
        items: [
            {
                ...
                cls: 'approve-btn',
                handler: function () {
                    changeOrderCreditStatus(record.get('id'), 2, grid);
            ...
            },
            {
                ...
                margin: '10',
                handler: function () {
                    changeOrderCreditStatus(record.get('id'), 3, grid);
                    this.up('window').close();
                }
            }
        ],
...
function changeOrderCreditStatus(id, status, grid) {
    Ext.Ajax.request({
